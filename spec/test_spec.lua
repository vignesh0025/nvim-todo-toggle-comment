...
-- print(extract_comment_without_label("/* FIX: This is fix comment */", "/%*(.+)%*/", "FIX:"))
-- print(extract_comment_without_label("/* This is default comment */", "/%*(.+)%*/", "FIX:"))
-- print(extract_comment_without_label("/*This is default comment with no start end space*/", "/%*(.+)%*/", "FIX:"))
-- print(extract_comment_without_label("/*This is default comment with no end space */", "/%*(.+)%*/", "FIX:"))
-- print(extract_comment_without_label("/* This is default comment with no start space*/", "/%*(.+)%*/", "FIX:"))
-- print(extract_comment_without_label("// FIX: This is fix inline comment", "//(.+)", "FIX:"))
-- print(extract_comment_without_label("//FIX: This is fix inline comment variant 1", "//(.+)", "FIX:"))
-- print(extract_comment_without_label("//FIX:This is fix inline comment variant 2", "//(.+)", "FIX:"))
-- print(extract_comment_without_label("/*TODO: This is todo comment with no start space */", "/%*(.+)%*/", "TODO:"))
-- print(extract_comment_without_label("/*TODO:This is todo comment with no space around space*/", "/%*(.+)%*/", "TODO:"))
--
--negative cases
-- print(extract_comment_without_label("/* TODO: This is todo comment", "/%*(.+)%*/", "TODO:"))

...
describe("Busted Unit Test: ", function()
	describe("extract_comment_without_label: ", function()
		...
		it("Default use case", function()
			assert.are.same(utils.extract_label_from_comment("/* TODO: This is a comment", labels), 1)
		end)

		it("Warning use case", function()
			assert.are.same(utils.extract_label_from_comment("/* WARNING: This is a comment", labels), 5)
		end)
